...
/* package DN-0.1.0.0 */
#define VERSION_DN "0.1.0.0"
#define MIN_VERSION_DN(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "DN-0.1.0.0-8yMn8QkkcEWDg7GIz2sx1m"

#define CURRENT_PACKAGE_KEY "DN-0.1.0.0-8yMn8QkkcEWDg7GIz2sx1m"
